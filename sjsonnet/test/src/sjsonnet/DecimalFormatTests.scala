...
object DecimalFormatTests extends TestSuite {
  ...
  def tests: Tests = Tests {
    ...
    test - { format("0.000000E00", 910) ==> "9.100000E+02" }
    test - { format("0E00", 910) ==> "9E+02" }
    test - { format("0E00", 0.009123) ==> "9E-03" }
    test - { format("0E0", 0.009123) ==> "9E-3" }
    test - { format("0E0", 0.000000000009123) ==> "9E-12" }
    test - { format("0.000000E00", -910) ==> "-9.100000E+02" }
    test - { format("0.0000E00", 910.3) ==> "9.1030E+02" }
    test - { format("0.E00", 910.3) ==> "9.E+02" }
    test - { format("0.E00", 900) ==> "9.E+02" }
    test - { format("0.000E00", 1000000001) ==> "1.000E+09" }
    ...
    test - { format("0.00E00", 1000000001) ==> "1.00E+09" }
    test - { format("0.00E00", 1100) ==> "1.10E+03" }
    test - { format("0.00", 1.1) ==> "1.10" }
    test - { format("0.0000E00", 1000000001) ==> "1.0000E+09" }
//    test - {format("0.0",1100) ==> "1100.0"}
//    test - {format("0.00",110) ==> "110.00"}
    test - { format("0.0000", 1.1) ==> "1.1000" }
    test - { format("0.##E00", 1000000001) ==> "1E+09" }
    test - { format("0.##E00", 1100) ==> "1.1E+03" }
