...
case class Config(
  ...
  @arg(
    name = "optimize-builtin-function-application",
    doc = """Enables rewrites of builtin function applications to use more efficient equivalents"""
  )
  optimizeBuiltinFunctionApplication: Flag = Flag(),
  @arg(
